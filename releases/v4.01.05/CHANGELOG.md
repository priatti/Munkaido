v4.01.05 [CURRENT] - 2025-10-19
 ...
 - Beállítások (PWA): „🔄 Frissítés ellenőrzése” gomb megjelenítve telepített PWA-ban is (nem a rejtett install-blokkban).
 - Beállítások (PWA): „➡️ Közvetlen váltás v4.01.06-ra” gomb hozzáadva a kézi migrációhoz.

Megjegyzés: v4.01.05 kijelölve CURRENT-nek és fagyasztva. A kiadás állapota végleges; a frissítés ellenőrzése és a közvetlen váltás gombok maradnak. További módosítások csak új verzió alatt készülnek.
