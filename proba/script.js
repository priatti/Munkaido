...
function applyFeatureToggles() {
    ...
    const earliestStartDisplay = document.getElementById('earliest-start-display');
    ...
    if (earliestStartDisplay) {
        earliestStartDisplay.style.display = showDriveTime ? 'block' : 'none';
    }
