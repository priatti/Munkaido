...
const DE_TRANSLATIONS = {
    ...
    menuSummaryDesc: "TÃ¤gliche, wÃ¶chentliche, monatliche Daten",
    menuStats: "Statistik",
    menuStatsDesc: "Detaillierte, blÃ¤tterbare Diagramme",
    ...
    menuSettingsDesc: "Datensicherung und persÃ¶nliche Daten",
    
    // Live-Ansicht
    liveOverviewTitle: "Ãœbersicht",
    liveNewDayTitle: "Neuen Arbeitstag starten",
    date: "Datum",
    time: "Uhrzeit",
    location: "Ort",
    weeklyDrive: "WÃ¶chentliche Lenkzeit",
    startKm: "Anfangs-km",
    startWorkday: "Arbeitstag starten",
    workdayInProgress: "Arbeitstag lÃ¤uft",
    startedAt: "Gestartet am",
    newBorderCrossing: "Neuer GrenzÃ¼bergang",
    getCountryCodeGPS: "LÃ¤ndercode per GPS abrufen",
    addBorderCrossing: "GrenzÃ¼bergang hinzufÃ¼gen",
    finishShift: "Schicht beenden",
    discardWorkday: "Arbeitstag verwerfen",
    recordedCrossings: "Erfasste ÃœbergÃ¤nge:",
    ...
    borderCrossings: "GrenzÃ¼bergÃ¤nge",
    addCrossing: "Neuen Ãœbergang hinzufÃ¼gen",
    weeklyDriveTimeHours: "WÃ¶chentliche Lenkzeit (Stunden)",
    atDayStart: "Bei Tagesbeginn (hh:mm)",
    atDayEnd: "Bei Tagesende (hh:mm)",
    kmReading: "Kilometerstand",
    endKm: "End-km",
    splitRestQuestion: "Gab es eine zusammenhÃ¤ngende Pause von 3+ Stunden? (Geteilt)",
    ...
    // Listenansicht
    listTitle: "EintrÃ¤ge",
    noEntries: "Noch keine EintrÃ¤ge vorhanden",
    ...
    entryCrossingsLabel: "GrenzÃ¼bergÃ¤nge",
