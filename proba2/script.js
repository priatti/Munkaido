const translations = {
    hu: {
        ...
        helpConceptDriveTimeDesc: "Ebbe a mezőbe nem a napi vezetési időt, hanem a tachográf által mutatott összesített heti vezetési időt kell beírni. Például: Nap elején: 28:24, Nap végén: 32:44. A program ebből számolja ki a napi vezetést.",
        ...
        helpSpecialStartCalcDesc: "A főképernyőn ('Áttekintés') található doboz az utolsó elmentett munkanapod befejezési időpontjából számolja ki, hogy legközelebb mikor indulhatsz, a napi pihenőidők figyelembevételével. A dátumot a nap nevével együtt írja ki a könnyebb átláthatóságért, pl.: <code>Péntek, 2025.09.05. 23:36</code>.",
    ...
    de: {
        ...
        helpConceptDriveTimeDesc: "In dieses Feld gehört nicht die tägliche Lenkzeit, sondern die kumulierte wöchentliche Lenkzeit vom Tachographen. Beispiel: Bei Tagesbeginn: 28:24, Bei Tagesende: 32:44. Die App berechnet daraus die tägliche Lenkzeit.",
        ...
        helpSpecialStartCalcDesc: "Das Feld auf dem Hauptbildschirm ('Übersicht') berechnet aus der Endzeit Ihres letzten gespeicherten Arbeitstages, wann Sie frühestens wieder starten dürfen, unter Berücksichtigung der täglichen Ruhezeiten. Das Datum wird zur besseren Übersicht mit dem Wochentag angezeigt, z.B.: <code>Freitag, 05.09.2025, 23:36</code>.",
