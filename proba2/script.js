...
function updateAllTexts() {
    ...
    document.querySelectorAll('[data-translate-key]').forEach(el => {
        ...
        if (translation !== undefined) {
            ...
            } else if (el.dataset.translateKeyHtml) {
...
function renderHelp() {
    ...
    container.innerHTML = `
        ...
        <div class="developer-intro-box">
            <h3 data-translate-key="developerIntroTitle">${i18n.developerIntroTitle}</h3>
            <p data-translate-key-html="developerIntroBody">${i18n.developerIntroBody}</p>
        </div>
    `;
}