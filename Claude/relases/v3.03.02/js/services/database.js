...
async function signInWithGoogle() {
    ...
    try {
        ...
        if (error.code === 'auth/popup-closed-by-user') { return; } // Csendes kilépés
...
async function handleAuthStateChange(user) {
    ...
    // Splash screen elrejtése mindenképp
...
// A FÁJL TOVÁBBI RÉSZE VÁLTOZATLAN MARAD (saveWorkRecord, deleteWorkRecord, stb.)
// ... illessze be ide a database.js fájl többi, meglévő részét ...
