...
doc.setFontSize(14); doc.setFont(undefined, 'normal'); doc.text(`${germanMonths[parseInt(month) - 1]} ${year}`, 105, 23, { align: 'center' });
doc.setFontSize(12); doc.text(userName, 105, 31, { align: 'center' });
    ...
    try {
        ...
        if (navigator.canShare && navigator.canShare({ files: [file] }) && navigator.share) {
            ...
            showCustomAlert(i18n.alertShareNotSupported || 'Die Teilen-Funktion wird nicht unterstützt. Bitte laden Sie die PDF herunter.', 'info');
        }
    } catch (error) {
