...
function renderStats() {
    ...
    if (!periodDisplay) {
        console.warn('stats-period-display not found');
        return;
    }
    ...
    safeSetTextContent('workTimeTotal', formatDuration(totals.work));
    safeSetTextContent('driveTimeTotal', formatDuration(totals.drive));
    safeSetTextContent('nightTimeTotal', formatDuration(totals.night));
    safeSetTextContent('kmTotal', `${Math.round(totals.km)} km`);

    if (!hasData && noDataEl && chartsContainer) {
        noDataEl.classList.remove('hidden');
        chartsContainer.classList.add('hidden');
    } else if (noDataEl && chartsContainer) {
