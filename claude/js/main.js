        ...
        <div id="finalize-modal" class="fixed inset-0 bg-black bg-opacity-60 flex items-center justify-center z-50 transition-opacity duration-300" onclick="handleModalBackdropClick(event)">
            <div class="bg-white dark:bg-gray-800 rounded-xl p-6 shadow-2xl w-11/12 max-w-md mx-auto transform transition-transform duration-300 scale-95">
                ...
                <div class="text-center mb-6">
                    ...
                    <p class="text-sm text-gray-600 dark:text-gray-400 mt-1">${i18n.finalizeShiftDesc}</p>
                </div>
                ...
                <div class="space-y-4">
                    ...
                    <div class="bg-gray-50 dark:bg-gray-700/50 rounded-lg p-3">
                        <label class="block text-sm font-medium text-gray-700 dark:text-gray-200 mb-2">
                            📍 ${i18n.finalizeEndLocationLabel}
                        </label>
                        <div class="flex">
                            <input type="text" id="finalizeEndLocation" class="flex-1 p-3 border border-gray-300 dark:border-gray-600 rounded-l-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 focus:ring-2 focus:ring-blue-500 focus:border-blue-500" placeholder="${i18n.cityPlaceholder}">
                            <button type="button" class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-3 rounded-r-lg border border-blue-500 transition-colors" onclick="fetchLocation('finalizeEndLocation')" title="${i18n.getLocationGPS}">
                                📍
                            </button>
                        </div>
                    </div>
                    ...
                    <div class="bg-indigo-50 dark:bg-indigo-900/50 rounded-lg p-3">
                        <label class="block text-sm font-medium text-indigo-700 dark:text-indigo-300 mb-2">
                            🚗 ${i18n.finalizeWeeklyDriveEndLabel}
                        </label>
