const translations = {
    hu: {
        ...
        // ÚJ: Dashboard fordítások
        currentShiftDuration: "Jelenlegi műszak",
        shiftStartTime: "Kezdés",
        crossingsToday: "Mai átlépések", 
        dashboardWorkToday: "Mai munkaidő",
        workDaysThisMonth: "Munkanapok e hónapban",
        // Teljes nap nézet
        ...
        // ÚJ: Műszak befejezés fordítások
        shiftEndLocation: "Befejezés helye",
        shiftEndLocationPrompt: "Add meg a munkanap befejezésének helyét:",
        weeklyDriveEndPrompt: "Add meg a végső heti vezetési időt:",
        endKmPrompt: "Add meg a végső kilométer állást:",
        // ÚJ: Állapot üzenetek
        noActiveShift: "Nincs aktív munkanap",
        shiftCancelled: "Munkanap elvetése",
        borderCrossingAdded: "Határátlépés hozzáadva!",
        // Üzenetek
    ...
    de: {
        ...
        // ÚJ: Dashboard fordítások
        currentShiftDuration: "Aktuelle Schicht",
        shiftStartTime: "Beginn",
        crossingsToday: "Heutige Übergänge",
        dashboardWorkToday: "Heutige Arbeitszeit", 
        workDaysThisMonth: "Arbeitstage diesen Monat",
        // ... itt folytatódna az összes többi német fordítás ...
        // Rövidség kedvéért csak a legfontosabbakat tüntetem fel
