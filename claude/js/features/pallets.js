...
function generatePalletReport() {
    ...
    // Event listener hozzáadása minden checkbox-hoz ÉS kezdeti állapot beállítása
    document.querySelectorAll('.pallet-report-checkbox').forEach(checkbox => {
        // Kezdeti állapot beállítása AZONNAL
...
function togglePalletReportLabel(checkbox) {
    ...
    // Minden osztály eltávolítása először
    ...
    if (checkbox.checked) {
        ...
        // Checkmark hozzáadása, ha még nincs ott
