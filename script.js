...
function renderHelp() {
    ...
    const createSection = (title, content) => `
        <div class="bg-gray-50 dark:bg-gray-700/50 p-4 rounded-lg mb-4">
            <h3 class="text-lg font-semibold mb-2 text-gray-800 dark:text-gray-100">${title}</h3>
    ...
    container.innerHTML = `
        ...
        ${createSection(i18n.helpSectionRecording, `
        ...
        ${createSection(i18n.helpSectionConcepts, `
        ...
        ${createSection(i18n.helpSectionTips, `
        ...
        ${createSection(i18n.helpSectionSpecial, `
        ...
        ${createSection(i18n.helpSectionData, `
        ...
        <div class="developer-intro-box">
            <h3 class="developer-intro-box h3">${i18n.developerIntroTitle}</h3>
            <p class="developer-intro-box p">${i18n.developerIntroBody}</p>
        </div>
    `;
}
